---
title: Frequently Asked Questions | Developer Documentation
---
...
We support both OIDC and Basic Auth for self-hosted deployments. For more information, please refer to the [Authentication Modes documentation](/llamaparse/self_hosting/configuration/auth-modes/index.md).
...
2. **Setup Ingress**: Configure proper ingress instead of relying on port-forwarding. See the [Ingress Configuration documentation](/llamaparse/self_hosting/configuration/ingress/index.md) for details.
