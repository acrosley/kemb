---
title: Parse and Analyze Excel Spreadsheets | Developer Documentation
---
...
![Example Spreadsheet](/_astro/example_spreadsheet.BmKC2Yqw_Z1qYBCC.png)
...
Once you have Parse set up, you can parse the example spreadsheet, which should result in the following output:
