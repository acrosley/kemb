---
title: Image Retrieval | Developer Documentation
---
...
![Enable Multi-modal retrieval](/_astro/enable_mm_retrieval_ui.CdBdOu7k_ZNOkGp.png)
...
Here is an example of setting this up using the [`LlamaCloudIndex` class](../../guides/framework_integration):

- [Python Framework](#tab-panel-242)
- [Python Client SDK](#tab-panel-243)
- [TypeScript Client SDK](#tab-panel-244)
...
- [Python Framework](#tab-panel-240)
...
- [Python Framework](#tab-panel-241)
...
For more advanced use cases, such as [composite retrieval](../composite) or async usage, refer to the [framework integration guide](../../guides/framework_integration) and [the API reference](/cloud-api-reference/llama-platform/index.md).
