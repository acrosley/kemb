---
title: Extracting Repeating Entities with Table Row Extraction | Developer Documentation
---
...
When using `extraction_target: "per_table_row"`, you define a schema for a **single entity** (e.g., one hospital, one product, one invoice line item), not the full document. LlamaExtract automatically:
...
📖 For more details, see the [Extraction Target documentation](../../guides/concepts/#extraction-target).

- [Python](#tab-panel-150)
- [Typescript](#tab-panel-151)
...
file_obj = client.files.create(file="BSC-Hospital-List-by-County.pdf", purpose="extract")
file_id = file_obj.id
...
- [Python](#tab-panel-154)
- [Typescript](#tab-panel-155)
...
file_obj = client.files.create(file="Click-BS-Toys-Catalogue-2024.pdf", purpose="extract")
file_id = file_obj.id
