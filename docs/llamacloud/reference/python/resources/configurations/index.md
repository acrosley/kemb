...
`configurations.list(ConfigurationListParams**kwargs)  -> SyncPaginatedCursor[ConfigurationResponse]`
...
- `product_type: Optional[List[Literal["split_v1", "extract_v2", "classify_v2", 3 more]]]`
...
`configurations.retrieve(strconfig_id, ConfigurationRetrieveParams**kwargs)  -> ConfigurationResponse`
...
`configurations.update(strconfig_id, ConfigurationUpdateParams**kwargs)  -> ConfigurationResponse`
