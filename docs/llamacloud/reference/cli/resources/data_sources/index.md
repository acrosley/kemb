...
`$ llamacloud-prod data-sources list`
...
- `Response List Data Sources Api V1 Data Sources Get: array of DataSource`
...
- `--source-type: "S3" or "AZURE_STORAGE_BLOB" or "GOOGLE_DRIVE" or 8 more`
...
- `--component: optional map[unknown] or CloudS3DataSource or CloudAzStorageBlobDataSource or 9 more`
...
- `data_source_reader_version_metadata: object { reader_version }`
