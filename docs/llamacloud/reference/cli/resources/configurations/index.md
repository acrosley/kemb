...
- `configuration_response: object { id, name, parameters, 4 more }`
  ...
  - `product_type: "split_v1" or "extract_v2" or "classify_v2" or 3 more`
...
`$ llamacloud-prod configurations list`
...
- `--product-type: optional array of "split_v1" or "extract_v2" or "classify_v2" or 3 more`
...
- `ConfigurationQueryResponse: object { items, next_page_token, total_size }`

  Paginated list of product configurations.

  - `items: array of ConfigurationResponse`
...
- `--parameters: optional SplitV1Parameters or ExtractV2Parameters or ClassifyV2Parameters or 3 more`
