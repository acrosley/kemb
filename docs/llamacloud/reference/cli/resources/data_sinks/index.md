...
`$ llamacloud-prod data-sinks list`
...
- `Response List Data Sinks Api V1 Data Sinks Get: array of DataSink`
...
- `--sink-type: "PINECONE" or "POSTGRES" or "QDRANT" or 4 more`
...
- `data_sink: object { id, component, name, 4 more }`
...
- `--component: optional map[unknown] or CloudPineconeVectorStore or CloudPostgresVectorStore or 5 more`
