...
`client.Configurations.New(ctx, params) (*ConfigurationResponse, error)`
...
- `params ConfigurationNewParams`

  - `ConfigurationCreate param.Field[ConfigurationCreate]`

    Body param: Request body for creating a product configuration.
    ...
    ConfigurationCreate: llamacloudprod.ConfigurationCreateParam{
      ...
      Parameters: llamacloudprod.ConfigurationCreateParametersUnionParam{
        OfSplitV1: &llamacloudprod.SplitV1Parameters{
          Categories: []llamacloudprod.SplitCategoryParam{llamacloudprod.SplitCategoryParam{
            Name: "x",
          }},
        },
      },
...
- `query ConfigurationListParams`
  ...
  - `ProductType param.Field[[]string]`
...
`client.Configurations.Update(ctx, configID, params) (*ConfigurationResponse, error)`
...
- `params ConfigurationUpdateParams`
  ...
  - `Parameters param.Field[ConfigurationUpdateParamsParametersUnion]`
    ...
    - `type ConfigurationUpdateParamsParametersSpreadsheetV1 struct{…}`
      ...
      - `TableMergeSensitivity string`
        ...
        - `const ConfigurationUpdateParamsParametersSpreadsheetV1TableMergeSensitivityStrong ConfigurationUpdateParamsParametersSpreadsheetV1TableMergeSensitivity = "strong"`

        - `const ConfigurationUpdateParamsParametersSpreadsheetV1TableMergeSensitivityWeak ConfigurationUpdateParamsParametersSpreadsheetV1TableMergeSensitivity = "weak"`
