...
- `PipelineListResponse = array of Pipeline`
...
- `PipelineRetrieveResponse = object { pipeline_id, retrieval_nodes, class_name, 5 more }`
...
- `pipeline_file_ids: optional array of string`
...
- `DataSourceGetDataSourcesResponse = array of PipelineDataSource`
...
- `DataSourceUpdateDataSourcesResponse = array of PipelineDataSource`
...
- `MetadataCreateResponse = map[string]`
