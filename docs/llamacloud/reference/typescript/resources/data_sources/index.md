...
`client.dataSources.list(DataSourceListParamsquery?, RequestOptionsoptions?): DataSourceListResponse`
...
- `DataSourceListResponse = Array<DataSource>`
...
`client.dataSources.create(DataSourceCreateParamsparams, RequestOptionsoptions?): DataSource`
...
`client.dataSources.update(stringdataSourceID, DataSourceUpdateParamsbody, RequestOptionsoptions?): DataSource`
...
- `body: DataSourceUpdateParams`
  ...
  - `component?: Record<string, unknown> | CloudS3DataSource | CloudAzStorageBlobDataSource | 9 more | null`
