...
`client.dataSinks.list(DataSinkListParamsquery?, RequestOptionsoptions?): DataSinkListResponse`
...
- `DataSinkListResponse = Array<DataSink>`
...
`client.dataSinks.create(DataSinkCreateParamsparams, RequestOptionsoptions?): DataSink`
...
`client.dataSinks.get(stringdataSinkID, RequestOptionsoptions?): DataSink`
