...
`client.configurations.create(ConfigurationCreateParamsparams, RequestOptionsoptions?): ConfigurationResponse`
...
`client.configurations.retrieve(stringconfigID, ConfigurationRetrieveParamsquery?, RequestOptionsoptions?): ConfigurationResponse`
...
- `query: ConfigurationRetrieveParams`
...
`client.configurations.update(stringconfigID, ConfigurationUpdateParamsparams, RequestOptionsoptions?): ConfigurationResponse`
...
- `params: ConfigurationUpdateParams`
  ...
  - `parameters?: SplitV1Parameters | ExtractV2Parameters | ClassifyV2Parameters | 3 more | null`
